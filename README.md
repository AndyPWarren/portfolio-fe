# SpectraKey AngularJS Frontend seed
...
### Clone the angular-seed Frontend repository

Clone the angular-seed repository using [git][git]:

```
cd path/to/parent/directory
git clone git@bitbucket.org:spectrakey/angular-seed.git
cd angular-seed
```
...
app/                    --> all of the files to be used in production
  ...
  components/           --> all app specific modules and views
  css/                  --> css files
...
There are two kinds of tests in the angular-seed frontend application: Unit tests and End to End tests.
